...
namespace DreamLifter.MatrixMarket
{
    ...
    {
        public static DoubleDenseMatrix Do(Func<Element, double, double, double, double, DoubleDenseMatrix> function, INumericalIntegration integrator, Element element)
        {
